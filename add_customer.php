...
<body>
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $id_card_photo_front = !empty($_FILES['id_card_photo_front']['tmp_name']) ? file_get_contents($_FILES['id_card_photo_front']['tmp_name']) : null;
            $id_card_photo_back = !empty($_FILES['id_card_photo_back']['tmp_name']) ? file_get_contents($_FILES['id_card_photo_back']['tmp_name']) : null;
            $license_photo = !empty($_FILES['license_photo']['tmp_name']) ? file_get_contents($_FILES['license_photo']['tmp_name']) : null;

            $sql = "INSERT INTO customers (first_name, last_name, company, ico, dico, permanent_address, correspondence_address, email, phone, license_number, license_validity, id_card_number, id_card_validity, id_card_photo_front, id_card_photo_back, license_photo)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssssssssssssssss", $first_name, $last_name, $company, $ico, $dico, $permanent_address, $correspondence_address, $email, $phone, $license_number, $license_validity, $id_card_number, $id_card_validity, $id_card_photo_front, $id_card_photo_back, $license_photo);
        ...
        <div class="form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="dico" name="dico">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="id_card_validity" name="id_card_validity">
                </div>
                <div class="form-group">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn">Přidat zákazníka</button>
